...
//Name: HandControl.ma
//Last modified: Thu, Jul 14, 2016 10:43:40 PM
//Codeset: 1252
requires maya "2014";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -1.4639821582586212 8.0241423025213319 9.6801309134123343 ;
	setAttr ".r" -type "double3" -39.338352729617824 -8.5999999999966832 0 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 12.658397921996549;
...
createNode nurbsCurve -n "controlShape" -p "control";
	...
	setAttr ".cc" -type "nurbsCurve" 
		...
		1.1318442262050217 0 -0.40601975166956822
		1.1979740704523585 0 -0.049656087688527917
